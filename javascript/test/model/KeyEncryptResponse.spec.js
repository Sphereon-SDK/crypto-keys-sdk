...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.KeyEncryptResponse();
  });
  ...
  describe('KeyEncryptResponse', function() {
    it('should create an instance of KeyEncryptResponse', function() {
      // uncomment below and update the code to test KeyEncryptResponse
      //var instane = new CryptoKeys.KeyEncryptResponse();
      //expect(instance).to.be.a(CryptoKeys.KeyEncryptResponse);
    });
