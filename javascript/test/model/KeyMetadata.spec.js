...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.KeyMetadata();
  });
  ...
  describe('KeyMetadata', function() {
    it('should create an instance of KeyMetadata', function() {
      // uncomment below and update the code to test KeyMetadata
      //var instane = new CryptoKeys.KeyMetadata();
      //expect(instance).to.be.a(CryptoKeys.KeyMetadata);
    });
