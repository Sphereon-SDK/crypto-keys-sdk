...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.SubjectAlternativeNames();
  });
  ...
  describe('SubjectAlternativeNames', function() {
    it('should create an instance of SubjectAlternativeNames', function() {
      ...
      //var instane = new CryptoKeys.SubjectAlternativeNames();
      //expect(instance).to.be.a(CryptoKeys.SubjectAlternativeNames);
    });
    ...
    it('should have the property userPrincipalNames (base name: "userPrincipalNames")', function() {
      // uncomment below and update the code to test the property userPrincipalNames
      //var instane = new CryptoKeys.SubjectAlternativeNames();
      //expect(instance).to.be();
    });
