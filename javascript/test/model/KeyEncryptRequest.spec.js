...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.KeyEncryptRequest();
  });
  ...
  describe('KeyEncryptRequest', function() {
    it('should create an instance of KeyEncryptRequest', function() {
      // uncomment below and update the code to test KeyEncryptRequest
      //var instane = new CryptoKeys.KeyEncryptRequest();
      //expect(instance).to.be.a(CryptoKeys.KeyEncryptRequest);
    });
