...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.CertificateMetadata();
  });
  ...
  describe('CertificateMetadata', function() {
    it('should create an instance of CertificateMetadata', function() {
      // uncomment below and update the code to test CertificateMetadata
      //var instane = new CryptoKeys.CertificateMetadata();
      //expect(instance).to.be.a(CryptoKeys.CertificateMetadata);
    });
