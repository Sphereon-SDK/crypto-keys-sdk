...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.KeyBundleResponse();
  });
  ...
  describe('KeyBundleResponse', function() {
    it('should create an instance of KeyBundleResponse', function() {
      // uncomment below and update the code to test KeyBundleResponse
      //var instane = new CryptoKeys.KeyBundleResponse();
      //expect(instance).to.be.a(CryptoKeys.KeyBundleResponse);
    });
