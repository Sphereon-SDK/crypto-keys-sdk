...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.SecretProperties();
  });
  ...
  describe('SecretProperties', function() {
    it('should create an instance of SecretProperties', function() {
      // uncomment below and update the code to test SecretProperties
      //var instane = new CryptoKeys.SecretProperties();
      //expect(instance).to.be.a(CryptoKeys.SecretProperties);
    });
