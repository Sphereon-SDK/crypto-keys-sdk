...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.DeletedCertificateBundleResponse();
  });
  ...
  describe('DeletedCertificateBundleResponse', function() {
    it('should create an instance of DeletedCertificateBundleResponse', function() {
      // uncomment below and update the code to test DeletedCertificateBundleResponse
      //var instane = new CryptoKeys.DeletedCertificateBundleResponse();
      //expect(instance).to.be.a(CryptoKeys.DeletedCertificateBundleResponse);
    });
    ...
    it('should have the property deletedCertificateBundle (base name: "deletedCertificateBundle")', function() {
      // uncomment below and update the code to test the property deletedCertificateBundle
      //var instane = new CryptoKeys.DeletedCertificateBundleResponse();
      //expect(instance).to.be();
    });
