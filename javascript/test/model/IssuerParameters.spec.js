...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.IssuerParameters();
  });
  ...
  describe('IssuerParameters', function() {
    it('should create an instance of IssuerParameters', function() {
      // uncomment below and update the code to test IssuerParameters
      //var instane = new CryptoKeys.IssuerParameters();
      //expect(instance).to.be.a(CryptoKeys.IssuerParameters);
    });
    ...
    it('should have the property cty (base name: "cty")', function() {
      // uncomment below and update the code to test the property cty
      //var instane = new CryptoKeys.IssuerParameters();
      //expect(instance).to.be();
    });
