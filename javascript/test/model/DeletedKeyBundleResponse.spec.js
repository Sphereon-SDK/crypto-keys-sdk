...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.DeletedKeyBundleResponse();
  });
  ...
  describe('DeletedKeyBundleResponse', function() {
    it('should create an instance of DeletedKeyBundleResponse', function() {
      // uncomment below and update the code to test DeletedKeyBundleResponse
      //var instane = new CryptoKeys.DeletedKeyBundleResponse();
      //expect(instance).to.be.a(CryptoKeys.DeletedKeyBundleResponse);
    });

    it('should have the property keyBundle (base name: "keyBundle")', function() {
      // uncomment below and update the code to test the property keyBundle
      //var instane = new CryptoKeys.DeletedKeyBundleResponse();
