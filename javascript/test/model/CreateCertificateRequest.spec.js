...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.CreateCertificateRequest();
  });
  ...
  describe('CreateCertificateRequest', function() {
    it('should create an instance of CreateCertificateRequest', function() {
      ...
      //var instane = new CryptoKeys.CreateCertificateRequest();
      //expect(instance).to.be.a(CryptoKeys.CreateCertificateRequest);
    });
