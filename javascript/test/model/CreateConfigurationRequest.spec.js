...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.CreateConfigurationRequest();
  });
  ...
  describe('CreateConfigurationRequest', function() {
    it('should create an instance of CreateConfigurationRequest', function() {
      ...
      //var instane = new CryptoKeys.CreateConfigurationRequest();
      //expect(instance).to.be.a(CryptoKeys.CreateConfigurationRequest);
    });
