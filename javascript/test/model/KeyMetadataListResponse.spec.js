...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.KeyMetadataListResponse();
  });
  ...
  describe('KeyMetadataListResponse', function() {
    it('should create an instance of KeyMetadataListResponse', function() {
      // uncomment below and update the code to test KeyMetadataListResponse
      //var instane = new CryptoKeys.KeyMetadataListResponse();
      //expect(instance).to.be.a(CryptoKeys.KeyMetadataListResponse);
    });

    it('should have the property keyMetadata (base name: "keyMetadata")', function() {
      // uncomment below and update the code to test the property keyMetadata
      //var instane = new CryptoKeys.KeyMetadataListResponse();
