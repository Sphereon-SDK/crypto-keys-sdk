...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.CertificateMetadataListResponse();
  });
  ...
  describe('CertificateMetadataListResponse', function() {
    it('should create an instance of CertificateMetadataListResponse', function() {
      // uncomment below and update the code to test CertificateMetadataListResponse
      //var instane = new CryptoKeys.CertificateMetadataListResponse();
      //expect(instance).to.be.a(CryptoKeys.CertificateMetadataListResponse);
    });

    it('should have the property certificateMetadata (base name: "certificateMetadata")', function() {
      // uncomment below and update the code to test the property certificateMetadata
      //var instane = new CryptoKeys.CertificateMetadataListResponse();
