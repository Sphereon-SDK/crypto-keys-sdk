...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.KeySignResponse();
  });
  ...
  describe('KeySignResponse', function() {
    it('should create an instance of KeySignResponse', function() {
      // uncomment below and update the code to test KeySignResponse
      //var instane = new CryptoKeys.KeySignResponse();
      //expect(instance).to.be.a(CryptoKeys.KeySignResponse);
    });
