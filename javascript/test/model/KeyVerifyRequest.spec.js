...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.KeyVerifyRequest();
  });
  ...
  describe('KeyVerifyRequest', function() {
    it('should create an instance of KeyVerifyRequest', function() {
      // uncomment below and update the code to test KeyVerifyRequest
      //var instane = new CryptoKeys.KeyVerifyRequest();
      //expect(instance).to.be.a(CryptoKeys.KeyVerifyRequest);
    });
