...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.KeyDecryptResponse();
  });
  ...
  describe('KeyDecryptResponse', function() {
    it('should create an instance of KeyDecryptResponse', function() {
      // uncomment below and update the code to test KeyDecryptResponse
      //var instane = new CryptoKeys.KeyDecryptResponse();
      //expect(instance).to.be.a(CryptoKeys.KeyDecryptResponse);
    });
    ...
    it('should have the property decrypted (base name: "decrypted")', function() {
      // uncomment below and update the code to test the property decrypted
      //var instane = new CryptoKeys.KeyDecryptResponse();
      //expect(instance).to.be();
    });
