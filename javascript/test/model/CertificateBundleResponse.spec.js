...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.CertificateBundleResponse();
  });
  ...
  describe('CertificateBundleResponse', function() {
    it('should create an instance of CertificateBundleResponse', function() {
      // uncomment below and update the code to test CertificateBundleResponse
      //var instane = new CryptoKeys.CertificateBundleResponse();
      //expect(instance).to.be.a(CryptoKeys.CertificateBundleResponse);
    });

    it('should have the property certificateBundle (base name: "certificateBundle")', function() {
      // uncomment below and update the code to test the property certificateBundle
      //var instane = new CryptoKeys.CertificateBundleResponse();
