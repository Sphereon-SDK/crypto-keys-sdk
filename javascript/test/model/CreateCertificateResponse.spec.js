...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.CreateCertificateResponse();
  });
  ...
  describe('CreateCertificateResponse', function() {
    it('should create an instance of CreateCertificateResponse', function() {
      // uncomment below and update the code to test CreateCertificateResponse
      //var instane = new CryptoKeys.CreateCertificateResponse();
      //expect(instance).to.be.a(CryptoKeys.CreateCertificateResponse);
    });
