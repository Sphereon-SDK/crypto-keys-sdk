...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.LocalStorageSettings();
  });
  ...
  describe('LocalStorageSettings', function() {
    it('should create an instance of LocalStorageSettings', function() {
      // uncomment below and update the code to test LocalStorageSettings
      //var instane = new CryptoKeys.LocalStorageSettings();
      //expect(instance).to.be.a(CryptoKeys.LocalStorageSettings);
    });
