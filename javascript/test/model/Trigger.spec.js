...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.Trigger();
  });
  ...
  describe('Trigger', function() {
    it('should create an instance of Trigger', function() {
      ...
      //var instane = new CryptoKeys.Trigger();
      //expect(instance).to.be.a(CryptoKeys.Trigger);
    });

    it('should have the property lifetimePercentage (base name: "lifetimePercentage")', function() {
      // uncomment below and update the code to test the property lifetimePercentage
      //var instane = new CryptoKeys.Trigger();
