...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.UpdateConfigurationRequest();
  });
  ...
  describe('UpdateConfigurationRequest', function() {
    it('should create an instance of UpdateConfigurationRequest', function() {
      // uncomment below and update the code to test UpdateConfigurationRequest
      //var instane = new CryptoKeys.UpdateConfigurationRequest();
      //expect(instance).to.be.a(CryptoKeys.UpdateConfigurationRequest);
    });
