...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.KeySignRequest();
  });
  ...
  describe('KeySignRequest', function() {
    it('should create an instance of KeySignRequest', function() {
      // uncomment below and update the code to test KeySignRequest
      //var instane = new CryptoKeys.KeySignRequest();
      //expect(instance).to.be.a(CryptoKeys.KeySignRequest);
    });
