...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.Configuration();
  });
  ...
  describe('Configuration', function() {
    it('should create an instance of Configuration', function() {
      ...
      //var instane = new CryptoKeys.Configuration();
      //expect(instance).to.be.a(CryptoKeys.Configuration);
    });

    it('should have the property azureKeyVaultSettings (base name: "azureKeyVaultSettings")', function() {
      // uncomment below and update the code to test the property azureKeyVaultSettings
      //var instane = new CryptoKeys.Configuration();
      //expect(instance).to.be();
    });

    it('should have the property implementationType (base name: "implementationType")', function() {
      // uncomment below and update the code to test the property implementationType
      //var instane = new CryptoKeys.Configuration();
      //expect(instance).to.be();
    });

    it('should have the property localStorageSettings (base name: "localStorageSettings")', function() {
      // uncomment below and update the code to test the property localStorageSettings
      //var instane = new CryptoKeys.Configuration();
      //expect(instance).to.be();
    });

    it('should have the property storageTypeType (base name: "storageTypeType")', function() {
      // uncomment below and update the code to test the property storageTypeType
      //var instane = new CryptoKeys.Configuration();
      //expect(instance).to.be();
    });
