...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.KeyDecryptRequest();
  });
  ...
  describe('KeyDecryptRequest', function() {
    it('should create an instance of KeyDecryptRequest', function() {
      // uncomment below and update the code to test KeyDecryptRequest
      //var instane = new CryptoKeys.KeyDecryptRequest();
      //expect(instance).to.be.a(CryptoKeys.KeyDecryptRequest);
    });
