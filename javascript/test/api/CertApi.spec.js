...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoKeys.CertApi();
  });
  ...
  describe('CertApi', function() {
    ...
    describe('getCert', function() {
      it('should call getCert successfully', function(done) {
        //uncomment below and update the code to test getCert
        //instance.getCert(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('importCert', function() {
      it('should call importCert successfully', function(done) {
        //uncomment below and update the code to test importCert
        //instance.importCert(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listCerts', function() {
      it('should call listCerts successfully', function(done) {
        //uncomment below and update the code to test listCerts
        //instance.listCerts(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
