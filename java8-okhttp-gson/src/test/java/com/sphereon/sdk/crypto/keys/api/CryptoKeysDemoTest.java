...
public class CryptoKeysDemoTest extends AbstractApiTest {
    ...
    public static final String  DEMO_CERT = "demoallcert";
    public static final String  DEMO_SYM_KEY = "demokey";
    ...
    public void certificateSigning() throws ApiException, ParseException, CertificateException, NoSuchAlgorithmException, InvalidKeySpecException, java.security.cert.CertificateException {
         ...
         */
        CertificateBundleResponse certResponse = certApi.getCert(CONFIG_NAME, DEMO_CERT, LATEST_VERSION);
        ...
        KeySignResponse keySignResponse = contentApi.signUsingKey(CONFIG_NAME, DEMO_CERT, LATEST_VERSION, keySignRequest);
        ...
        KeyVerifyRequest keyVerifyRequest = new KeyVerifyRequest()
                ...
                .digest(sha256Hash);
        KeyVerifyResponse keyVerifyResponse = contentApi.verifyUsingKey(CONFIG_NAME, DEMO_CERT, LATEST_VERSION, keyVerifyRequest);
         ...
         */
        KeySignResponse symKeySignResponse = contentApi.signUsingKey(CONFIG_NAME, DEMO_SYM_KEY, LATEST_VERSION, keySignRequest);
        ...
        KeyVerifyResponse symKeyVerifyResponse = contentApi.verifyUsingKey(CONFIG_NAME, DEMO_SYM_KEY, LATEST_VERSION, keyVerifyRequest);
        ...
        KeyEncryptResponse keyEncryptResponse = contentApi.encryptUsingKey(CONFIG_NAME, DEMO_CERT, LATEST_VERSION, keyEncryptRequest);
        ...
        KeyDecryptResponse keyDecryptResponse = contentApi.decryptUsingKey(CONFIG_NAME, DEMO_CERT, LATEST_VERSION, keyDecryptRequest);
