...
namespace Sphereon.SDK.Crypto.Keys.Model
{
    ...
    public partial class KeyBundle :  IEquatable<KeyBundle>, IValidatableObject
    {
        ...
        public KeyBundle(Dictionary<string, string> BackendMetadata = default(Dictionary<string, string>), Dictionary<string, string> ApplicationMetadata = default(Dictionary<string, string>), bool? Managed = default(bool?), Attributes Attributes = default(Attributes), JsonWebKey Key = default(JsonWebKey))
        {
            // to ensure "Key" is required (not null)
            if (Key == null)
            {
                throw new InvalidDataException("Key is a required property for KeyBundle and cannot be null");
            }
            else
            {
                this.Key = Key;
