...
namespace Sphereon.SDK.Crypto.Keys.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationResponse :  IEquatable<ConfigurationResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ConfigurationResponse(Configuration Configuration = default(Configuration))
        {
            // to ensure "Configuration" is required (not null)
            if (Configuration == null)
            {
                throw new InvalidDataException("Configuration is a required property for ConfigurationResponse and cannot be null");
            }
            else
            {
