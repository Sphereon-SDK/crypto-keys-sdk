...
namespace Sphereon.SDK.Crypto.Keys.Model
{
    ...
    public partial class Trigger :  IEquatable<Trigger>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="LifetimePercentage">The percentage of the lifetime of the certificate at which to execute the action. eg 90.</param>
        /// <param name="DaysBeforeExpiry">The amount of days before the certificate expires.</param>
        ...
        /// </summary>
        /// <value>The percentage of the lifetime of the certificate at which to execute the action. eg 90</value>
        [DataMember(Name="lifetimePercentage", EmitDefaultValue=false)]
        public int? LifetimePercentage { get; set; }

        /// <summary>
        /// The amount of days before the certificate expires
        /// </summary>
        /// <value>The amount of days before the certificate expires</value>
        [DataMember(Name="daysBeforeExpiry", EmitDefaultValue=false)]
