...
namespace Sphereon.SDK.Crypto.Keys.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KeyEncryptRequest :  IEquatable<KeyEncryptRequest>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Alg
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyEncryptRequest" /> class.
        /// </summary>
        /// <param name="Input">Input.</param>
        /// <param name="Alg">Alg.</param>
        public KeyEncryptRequest(byte[] Input = default(byte[]), AlgEnum? Alg = default(AlgEnum?))
        {
            this.Input = Input;
            this.Alg = Alg;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KeyEncryptRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as KeyEncryptRequest);
        }

        /// <summary>
        /// Returns true if KeyEncryptRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of KeyEncryptRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeyEncryptRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
