...
namespace Sphereon.SDK.Crypto.Keys.Model
{
    ...
    public partial class CreateConfigurationRequest :  IEquatable<CreateConfigurationRequest>, IValidatableObject
    {
        ...
        public CreateConfigurationRequest(Configuration Configuration = default(Configuration))
        {
            // to ensure "Configuration" is required (not null)
            if (Configuration == null)
            {
                throw new InvalidDataException("Configuration is a required property for CreateConfigurationRequest and cannot be null");
            }
            else
            {
