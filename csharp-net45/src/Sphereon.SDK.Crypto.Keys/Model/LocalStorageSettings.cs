...
namespace Sphereon.SDK.Crypto.Keys.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LocalStorageSettings :  IEquatable<LocalStorageSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocalStorageSettings" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocalStorageSettings {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LocalStorageSettings);
        }

        /// <summary>
        /// Returns true if LocalStorageSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of LocalStorageSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocalStorageSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
