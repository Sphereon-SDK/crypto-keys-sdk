...
namespace Sphereon.SDK.Crypto.Keys.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KeyEncryptResponse :  IEquatable<KeyEncryptResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KeyEncryptResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as KeyEncryptResponse);
        }

        /// <summary>
        /// Returns true if KeyEncryptResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of KeyEncryptResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeyEncryptResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
